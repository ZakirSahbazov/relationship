...
const DICTIONARIES = {
  en: {
    ...
    hero_sub: "When your friend taps the link and types their name, you'll instantly see how well you click.",
  ...
  ru: {
    ...
    hero_sub: "Как только друг перейдёт по ссылке и введёт имя, сразу станет ясно, насколько вы подходите друг другу.",
  ...
  hi: {
    ...
    hero_sub: "जब आपका दोस्त लिंक पर टैप करके अपना नाम लिखेगा, तो आप दोनों के बीच की केमिस्ट्री तुरंत सामने आ जाएगी।",
  ...
  id: {
    ...
    hero_sub: "Saat temanmu mengetuk link dan mengetik namanya, langsung ketahuan seberapa cocok kalian.",
  ...
  ur: {
    ...
    hero_sub: "جب آپ کا دوست لنک پر ٹیپ کر کے اپنا نام لکھے گا، تو فوراً پتہ چل جائے گا کہ آپ دونوں میں کتنی ہم آہنگی ہے۔",
  ...
  tr: {
    ...
    hero_sub: "Arkadaşın linke tıklayıp adını yazınca, aranızdaki ilişki seviyeniz anında ortaya çıkar.",
  ...
  uk: {
    ...
    hero_sub: "Щойно твій друг перейде за посиланням і введе ім'я — одразу стане зрозуміло, наскільки ви підходите одне одному.",
  ...
  uz: {
    ...
    hero_sub: "Do'stingiz havolani bosib ismini yozganda, ikkalangiz qanchalik mos ekanligingiz darhol ma'lum bo'ladi.",
  ...
  fa: {
    ...
    hero_sub: "وقتی دوستت روی لینک بزند و اسمش را بنویسد، همخوانی شما با هم فوراً مشخص می‌شود.",
  ...
  pt: {
    ...
    hero_sub: "Quando seu amigo tocar no link e digitar o nome, vocês descobrem na hora o quanto combinam.",
  ...
  ar: {
    ...
    hero_sub: "بمجرد أن يضغط صديقك على الرابط ويكتب اسمه، ستعرفان فوراً مدى انسجامكما.",
  ...
  de: {
    ...
    hero_sub: "Sobald dein Freund auf den Link tippt und seinen Namen eingibt, seht ihr sofort, wie gut ihr zusammenpasst.",
  ...
  it: {
    ...
    hero_sub: "Quando il tuo amico tocca il link e scrive il suo nome, scoprite subito quanto siete affini.",
  ...
  es: {
    ...
    hero_sub: "Cuando tu amigo toque el enlace y escriba su nombre, descubrís al instante qué tan bien encajáis.",
  ...
  fil: {
    ...
    hero_sub: "Kapag pinindot ng kaibigan mo ang link at na-type ang pangalan niya, agad ninyong malalaman kung gaano kayo kagma.",
